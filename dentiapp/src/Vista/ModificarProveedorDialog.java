...
public class ModificarProveedorDialog extends JDialog {
	...
	private JTextField txtBuscaProv;
	...
	public ModificarProveedorDialog() {
		...
		txtTelefono.setBounds(419, 277, 294, 47);
		...
		txtNombre.setBounds(58, 277, 291, 47);
		...
		txtBuscaProv = new JTextField();
		txtBuscaProv.setBounds(422, 147, 291, 46);
		txtBuscaProv.setBorder(new MatteBorder(0, 0, 1, 0, (Color) new Color(0, 0, 0)));
		txtBuscaProv.setBackground(new Color(246, 246, 246));
		contentPanel.add(txtBuscaProv);
		txtBuscaProv.setColumns(10);
		
		cmbProveedor.setModel(rellenarDatos("proveedor", "nombre", modeloDatos));
		txtBuscaProv.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {

				cmbProveedor.setModel(rellenarDatos("proveedor", "nombre", modeloDatos));
				String textoBusqueda = txtBuscaProv.getText().toLowerCase();
