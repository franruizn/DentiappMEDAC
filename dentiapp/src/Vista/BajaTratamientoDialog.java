...
public class BajaTratamientoDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			BajaTratamientoDialog dialog = new BajaTratamientoDialog();
	...
	public BajaTratamientoDialog() throws SQLException {
		...
		JLabel lblProv = new JLabel("BAJA TRATAMIENTO");
		lblProv.setFont(new Font("SansSerif", Font.BOLD, 29));
		lblProv.setBounds(238, 32, 297, 38);
		...
		contentPanel.add(btnAceptar);
		{
			...
			lblFondo.setIcon(new ImageIcon(BajaTratamientoDialog.class.getResource("/fotos/baja_alta.png")));
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(op == 0) {
					try {
						con.cambiarBaja(seleccionado,"tratamiento","idtratamiento");
						...
						JOptionPane.showMessageDialog(null, "Error al dar de Baja al tratamiento",
