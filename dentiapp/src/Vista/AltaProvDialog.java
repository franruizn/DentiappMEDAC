...
public class AltaProvDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AltaProvDialog dialog = new AltaProvDialog();
	...
	public AltaProvDialog() throws SQLException {
		...
		JLabel lblProv = new JLabel("ALTA PROVEEDOR");
		...
		contentPanel.add(btnAceptar);
		{
			...
			lblFondo.setIcon(new ImageIcon(AltaProvDialog.class.getResource("/fotos/baja_alta.png")));
		...
		btnAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String id;
				int op = JOptionPane.showConfirmDialog(null, "¿Seguro que quiere dar de alta el proveedor " + cmbStock.getSelectedItem() + "?", "Confirmar baja", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
				if(op == 0) {
					try {
						con.cambiarAlta(seleccionado,"proveedor","idproveedor");
